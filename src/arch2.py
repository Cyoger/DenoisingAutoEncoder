...
validation_sample_list = file_list[int(0.8*len(file_list)):]

training_data_gen = DataGenerator(training_sample_list, path)
validation_data_gen = DataGenerator(validation_sample_list, path)
'''
...
# prediction = autoencoder.predict(new)
